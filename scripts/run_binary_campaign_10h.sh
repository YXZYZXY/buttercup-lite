...
CONTROL_DIR="${ROOT}/runtime/campaign_control/binary_10h"
...
spec = TaskSpec(
    source=TaskSource(adapter_type=AdapterType.BINARY, uri="campaign://cjson_source_derived_binary_10h"),
    metadata={
        "benchmark": "cjson_source_derived_binary",
        "target_mode": "binary",
        "base_task_id": "0f09df1f-072b-4236-adca-cd58533532bd",
